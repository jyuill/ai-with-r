...
An experiment in using LLMs to analyze data within R environment.
Using the [BC Liquor Market Report](https://www.bcldb.com/files/Liquor_Market_Review_F24_25_Q4_March_2025.pdf), a pdf document with text and tables as example.
